      ...
      <nav className="flex flex-col gap-3">
        <Link href="/ask" className="block border rounded p-4 hover:bg-gray-50">
          ...
          <p className="text-xs text-gray-500 mt-1">
            Query ingested documents with RAG and see citations.
          </p>
        </Link>
        ...
        <Link href="/workflows" className="block border rounded p-4 hover:bg-gray-50">
          <span className="font-semibold">Workflows</span>
          <p className="text-xs text-gray-500 mt-1">
            Run support triage and approval-gated email drafts.
          </p>
        </Link>
        <Link href="/evals" className="block border rounded p-4 hover:bg-gray-50">
          <span className="font-semibold">Evaluations</span>
          <p className="text-xs text-gray-500 mt-1">
            RAGAS scores for faithfulness, relevancy, and precision.
          </p>
        </Link>
      </nav>
    </main>
